...
\vspace{0.1in}
 ...
 %   美国机械工程师学会 (ASME), 会员 % S06, M13
    ...
    编委, 2015 美国控制会议 (ACC)\\
    领域和分会组织者, 2014 ASME 国际动力系统和控制会议  (DSCC)\\
    程序委员会, 2013 IEEE 国际信息和自动化会议 (ICIA)\\
    程序委员会, 2013 IEEE 国际机器人和仿生学会议 (ROBIO)\\
    分会主席，2013 ASME 国际动力系统和控制会议 (DSCC)
