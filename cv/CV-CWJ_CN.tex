...
\section{专利}
\begin{etaremune}
	\item 具备计算传感器的位置和方向的功能的机器人系统 {\it \\JP-6174654 ({\bf已授权}), US-15/281084 (审批中), CN-201610811511.0 (审批中), DE-102016012065.7 (审批中)}
	\item 物体的姿势计算系统 {\it \\JP-6208724 ({\bf已授权}), US-15/259118 (审批中), CN-201610814842.X (审批中), DE-102016116404.6 (审批中)}
