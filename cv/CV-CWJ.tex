...
\section{PATENTS}
\begin{etaremune}
	\item "Robot system with function to calculate sensor position and orientation" {\it \\JP-2015203902 (Issued), US-15/281084 (Pending), \\CN-201610811511.0 (Pending), DE-102016012065.7 (Pending)}
	\item "Object posture calculation system" {\it \\JP-2015177471 (Issued), US-15/259118 (Pending), \\CN-201610814842.X (Pending), DE-102016116404.6 (Pending)}
