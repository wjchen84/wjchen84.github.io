...
%\\item \textbf{1000-Talent Plan}, Zhejiang Province \hfill{2019}
...
\begin{etaremune}
	...
	\item Robot system having learning control function and learning control method {\it \\US10618164B2 ({\bf Granted}), \\CN108422420B ({\bf Granted}), DE102018001026A1 (Disclosed)}%JP6484265B2 ({\bf Granted}), 
	\item Device, system, and method for automatically generating motion path of robot {\it \\US20180290302A1 (Disclosed),\\CN108687770A (Disclosed), DE102018107857A1 (Disclosed)}%JP2018176332A (Disclosed), 
	...
	\item Robot system {\it \\JP6564433B2 ({\bf Granted}),\\CN109421049B ({\bf Granted}), DE102018214272A1 (Disclosed)}%, US20190061149A1 (Disclosed)
