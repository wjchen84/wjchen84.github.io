...
\section{PATENTS}
\vspace{0.1in}
\textbf{5 Granted + 11 Disclosed + 20 Pending}, across \textbf{China, Japan, US}, and \textbf{Germany}
\begin{etaremune}
	\item Robot system having function to calculate position and orientation of sensor {\it \\JP6174654 ({\bf Granted}), US9937620B2 ({\bf Granted}), \\CN106584489A (Disclosed), DE102016012065A1 (Disclosed)}
	\item Object posture calculation system {\it \\JP6208724 ({\bf Granted}), US9903698B2 ({\bf Granted}), \\CN201610814842.X ({\bf Granted}), DE102016116404A1 (Disclosed)}
	...
	\item Device and method to recognize shape and generate robot program {\it \\JP2017104819 (Pending), US15/964472 (Pending),\\CN201810473576.8 (Pending), DE102018206193.9 (Pending)}
...
\vspace{0.3in}
\centerline{\footnotesize Updated on June 20, 2018}
