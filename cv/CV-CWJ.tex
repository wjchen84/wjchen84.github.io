...
\item {\bf Adjunct Associate Professor}, ZJU-UIUC Institute, Zhejiang University \hfill 01/2019 -- Present

\item {\bf CTO \& Partner}, Sihe Inc. (思核科技) \hfill 07/2018 -- Present
\begin{itemize}
	\item Manage and lead the company's R\&D with a focus on industrial AI \& robotics
...
\section{PATENTS}
\vspace{0.1in}
\textbf{7 Granted + 25 Disclosed + 7 Pending}, across \textbf{China, Japan, US}, and \textbf{Germany}
\begin{etaremune}
	\item Robot system having function to calculate position and orientation of sensor {\it \\JP6174654B2 ({\bf Granted}), US9937620B2 ({\bf Granted}), \\CN106584489B ({\bf Granted}), DE102016012065A1 (Disclosed)}
	\item Object posture calculation system {\it \\JP6208724B2 ({\bf Granted}), US9903698B2 ({\bf Granted}), \\CN106514712B ({\bf Granted}), DE102016116404A1 (Disclosed)}
	\item Robot apparatus having learning function {\it \\JP6386516B2 ({\bf Granted}), US20170205802A1 (Disclosed), \\CN106965171A (Disclosed), DE102017000063A1 (Disclosed)}
	\item Robot control device {\it \\JP2018027580A (Disclosed), US20180050452A1 (Disclosed), \\CN107756423A (Disclosed), DE102017118276A1 (Disclosed)}
	\item Robot system having learning control function and learning control method {\it \\JP2018130800A (Disclosed), US20180229364A1 (Disclosed), \\CN108422420A (Disclosed), DE102018001026A1 (Disclosed)}
	\item Device, system, and method for automatically generating motion path of robot {\it \\JP2018176332A (Disclosed), US20180290302A1 (Disclosed),\\CN108687770A (Disclosed), DE102018107857A1 (Disclosed)}
	\item Shape recognition device, shape recognition method, and program {\it \\JP2018200558A (Disclosed), US20180341828A1 (Disclosed),\\CN108932363A (Disclosed), DE102018206193A1 (Disclosed)}
	\item Gripper control device, gripper control method, and gripper simulation device {\it \\JP2019010713A (Disclosed), US20190001508A1 (Disclosed),\\CN109202942A (Disclosed), DE102018115451A1 (Disclosed)}
	\item Robot system {\it \\JP2017164063 (Pending)}
	\item Controller device and machine learning device {\it \\JP2018079450 (Pending)}
	\item Robot hand controller device and system {\it \\JP2018075572 (Pending)}
...
%\vspace{0in}
\begin{list}{$\bullet$}{\setlength\leftmargin{0in}\setlength\topsep{0in}}
\item \makebox[0.8in][l]{12/22/2018} "Intelligent Robotic Technologies and Industrial Applications", Polytechnic Institute, Zhejiang University
...
\vspace{0.3in}
\centerline{\footnotesize Updated on Feb. 9, 2019}
