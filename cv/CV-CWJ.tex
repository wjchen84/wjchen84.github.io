...
\item {\bf Chief Research Engineer (主任)}, FANUC Corporation \hfill 10/2017 -- Present\\
Robot Software Research Department, Basic Laboratory
\begin{itemize}
...
\item {\bf Chief Research Engineer (主任)}, FANUC Corporation \hfill 11/2013 -- 10/2017\\
...
\section{PATENTS}
\begin{etaremune}
	\item Robot system with function to calculate sensor position and orientation {\it \\JP-2015203902 (Granted), US-15/281084 (Pending), CN-201610811511.0 (Pending), DE-102016012065.7 (Pending)}
	\item Object posture calculation system {\it \\JP-2015177471 (Granted), US-15/259118 (Pending), CN-201610814842.X (Pending), DE-102016116404.6 (Pending)}
	...
	\item Device and method to recognize shape and generate program {\it \\JP-2017104819 (Pending)}
...
\vspace{0.3in}
\centerline{\footnotesize Updated on September 27, 2017}
