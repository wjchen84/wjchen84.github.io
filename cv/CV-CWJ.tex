...
\name{WENJIE CHEN}
\address{
%\centerline{\textbf{Citizenship:} Chinese; $\;\;$ \textbf{Visa:} F1-OPT}\\
%\centerline{2103 Etcheverry Hall, Department of Mechanical Engineering}\\
%\centerline{University of California, Berkeley, CA 94720--1740}\\
%\centerline{\textbf{Email:} wjchen@berkeley.edu; \textbf{Mobile:} 510--277--2850}\\
...
\vspace{0.1in}
Theory and application of dynamic systems and control; robotic/mechatronic systems. Applications to industrial robots, wearable assistive robotics, robots for advanced manufacturing.
...
%    \makebox[0.65in][l]{Postdoc.} \makebox[2.5in][l]{\bf University of California, Berkeley} \makebox[0.75in][l]{Mechanical Engineering} \hfill 08/2012 -- Present
...
\vspace{0.1in}
    ...
    External Reviewer of the Research Grants Council, Hong Kong (2013, 2014, 2016)
    ...
    Associate Editor, 2016 ASME Dynamic Systems and Control Conference (DSCC);\\
...
%    \vspace{-0.1in}
    ...
    \item Junkai Lu, Kevin Haninger, \textbf{Wenjie Chen}, Masayoshi Tomizuka, Suraj Gowda, and Jose M. Carmena, "Design of a Passive Upper Limb Exoskeleton for Macaque Monkeys," \emph{ASME Journal of Dynamic Systems, Measurement, and Control}, 2016, under review
    \item Pedro Reynoso-Mora, \textbf{Wenjie Chen}, and Masayoshi Tomizuka, "A Convex Relaxation for the Time-optimal Trajectory Planning of Robotic Manipulators along Predetermined Geometric Paths," \emph{Optimal Control Applications and Methods}, 2016; doi: 10.1002/oca.2234
...
%    \item C. Wang$^*$, \textbf{W. Chen}, and M. Tomizuka, "Robot End-effector Sensing with Position Sensitive Detector and Inertial Sensors," \emph{IEEE Transactions on Industrial Electronics}, in preparation
    ...
    \textbf{Refereed Conference Proceedings} %\small{($*$ denotes corresponding author)}
%    \vspace{-0.1in}
    \begin{etaremune}[start=26]
    \item Chung-Yen Lin, \textbf{Wenjie Chen}, and Masayoshi Tomizuka, "Learning Control for Task Specific Industrial Robots," \emph{the 55th IEEE Conference on Decision and Control (CDC)}, Las Vegas, USA, December 12--14, 2016, submitted
	\item Te Tang, Changliu Liu, \textbf{Wenjie Chen}, and Masayoshi Tomizuka, "Robotic Manipulation of Deformable Objects by Tangent Space	Mapping and Non-Rigid Registration," \emph{the 2016 IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)}, Deajeon, Korea, October 9--14, 2016, submitted
	\item Yu Zhao, \textbf{Wenjie Chen}, Te Tang, and Masayoshi Tomizuka, "Zero Time Delay Input Shaping for Smooth Settling of Industrial Robots," \emph{the 12th Conference on Automation Science and Engineering (CASE, ISAM 2016)}, Fort Worth, TX, USA, August 21--24, 2016, submitted
	...
	\item Te Tang, Hsien-Chung Lin, Yu Zhao, \textbf{Wenjie Chen}, and Masayoshi Tomizuka, "Autonomous Alignment of Peg and Hole by Force/Torque Measurement for Robotic Assembly," \emph{the 12th Conference on Automation Science and Engineering (CASE, ISAM 2016)}, Fort Worth, TX, USA, August 21--24, 2016, submitted
	\item Te Tang, Hsien-Chung Lin, Yu Zhao, Yongxiang Fan, \textbf{Wenjie Chen}, and Masayoshi Tomizuka, "Teach Industrial Robots Peg-Hole-Insertion by Human Demonstration," \emph{the 2016 IEEE/ASME International Conference on Advanced Intelligent Mechatronics (AIM)}, Banff, Alberta, Canada, July 12--15, 2016, submitted
    \item Yongxiang Fan, Hsien-Chung Lin, Yu Zhao, Chung-Yen Lin, Te Tang, Masayoshi Tomizuka, and \textbf{Wenjie Chen}, "Object Position and Orientation Tracking for Manipulators Considering Unnegligible Sensor Physics," \emph{the 2016 International Symposium on Flexible Automation (ISFA)}, Cleveland, USA, August 1--3, 2016, submitted
    \item Hsien-Chung Lin, Te Tang, Yongxiang Fan, Yu Zhao, Masayoshi Tomizuka, and \textbf{Wenjie Chen}, "Robot Learning from Human Demonstration with Remote Lead through Teaching," \emph{the 2016 European Control Conference (ECC)}, Aalborg, Denmark, June 29--July 1, 2016, accepted
    \item Chung-Yen Lin, Yu Zhao, Masayoshi Tomizuka, and \textbf{Wenjie Chen}, "Path-Constrained Trajectory Planning for Robot Service Life Optimization," \emph{the 2016 American Control Conference (ACC)}, Boston, MA, USA,July 6--8, 2016, accepted
...
\vspace{0.3in}
\centerline{\footnotesize Updated on March 23, 2016}
