...
\section{PATENTS}
\begin{etaremune}
	\item Robot system having function to calculate position and orientation of sensor {\it \\JP-6174654 ({\bf Granted}), US-15/281084 ({\bf Approved \& Grant Pending}), CN-201610811511.0 (Pending), DE-102016012065.7 (Pending)}
	\item Object posture calculation system {\it \\JP-6208724 ({\bf Granted}), US-15/259118 ({\bf Granted}), CN-201610814842.X ({\bf Approved \& Grant Pending}), DE-102016116404.6 (Pending)}
