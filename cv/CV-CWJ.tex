...
%    Mechatronic Engineering (\emph{Rank: 1/55})\\
    \makebox[1.25in][l]{\emph{Rank: 1/55(major)}} \hfill ACEE of Chu Kochen Honors College (\emph{63 elites from over 6000})\\
...
\section{PATENTS}
\vspace{0.1in}
\textbf{12 Granted + 24 Disclosed + 7 Pending}, across \textbf{China, Japan, US}, and \textbf{Germany}
\begin{etaremune}
	...
	\item Robot apparatus having learning function {\it \\JP6386516B2 ({\bf Granted}), US10254741B2 ({\bf Granted}), \\CN106965171A (Disclosed), DE102017000063A1 (Disclosed)}
	...
	\item Robot system having learning control function and learning control method {\it \\JP6484265B2 ({\bf Granted}), US20180229364A1 (Disclosed), \\CN108422420A (Disclosed), DE102018001026A1 (Disclosed)}
	...
	\item Shape recognition device, shape recognition method, and program {\it \\JP6499716B2 ({\bf Granted}), US20180341828A1 (Disclosed),\\CN108932363A (Disclosed), DE102018206193A1 (Disclosed)}
	...
	\item Robot system {\it \\JP2019038089A (Disclosed), US20190061149A1 (Disclosed),\\CN109421049A (Disclosed), DE102018214272A1 (Disclosed)}
	...
	\item Parameter adaptation according to motion command {\it \\JP2018134393 (Pending)}
\end{etaremune}
...
\vspace{0.05in}
\begin{list}{$\bullet$}{\setlength\leftmargin{0in}\setlength\topsep{0in}}
\item \makebox[0.8in][l]{01/04/2020} "Intelligent Robots: Robot Learning and its Industrial Applications", Polytechnic Institute, Zhejiang University
...
\vspace{0.3in}
\centerline{\footnotesize Updated on March 8, 2020}
