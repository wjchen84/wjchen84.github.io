...
\item {\bf Senior Research Engineer £¨Ö÷ÈÎ£©}, FANUC Corporation \hfill 11/2013 -- Present\\
...
\vspace{0.1in}
    ...
    Award Judge of IERA Award (Innovation and Entrepreneurship in Robotics and Automation), IEEE/RAS and IFR, 2017
...
\begin{etaremune}[start=8]
	\item "Robot system having function to calculate position and orientation of sensor" {\it \\JP-2015203902 (Pending), US-15/281084 (Pending), \\CN-201610811511.0 (Pending), DE-102016012065.7 (Pending)}
	\item "Object posture calculation system" {\it \\JP-2015177471 (Pending), US-15/259118 (Pending), \\CN-201610814842.X (Pending), DE-102016116404.6 (Pending)}
	\item "Robot system with learning function" {\it \\JP-2016225207 (Pending), US-15/405190 (Pending), \\CN-201710025546.6 (Pending), DE-102017000063.8 (Pending)}
	\item "Robot control system" {\it \\JP-2016159895 (Pending)}
	\item "Robot system and learning control method for learning control function" {\it \\JP-2017026317 (Pending)}
	\item "Device, system, and method to automatically generate robot motion trajectories" {\it \\JP-2017077711 (Pending)}
	\item "Device and method to recognize shape and genearte program" {\it \\JP-2017104819 (Pending)}
	\item "In-hand object manipulation through multi-finger robot hand" {\it \\JP (Pending)}
\end{etaremune}
...
\begin{list}{$\bullet$}{\setlength\leftmargin{0in}\setlength\topsep{0in}}
<<<<<<< HEAD
\item \makebox[0.8in][l]{05/29/2017} "Robotic Learning in Industrial Applications", \emph{ICRA 2017 Workshop "Recent Advances in Dynamics for Industrial Applications"}, Singapore
=======
...
>>>>>>> f7b056b1a881e5fcbb71d4a97b30d1b7cb433aba
...
\vspace{0.3in}
<<<<<<< HEAD
\centerline{\footnotesize Updated on June 12, 2017}
=======
\centerline{\footnotesize Updated on June 27, 2017}
>>>>>>> f7b056b1a881e5fcbb71d4a97b30d1b7cb433aba
